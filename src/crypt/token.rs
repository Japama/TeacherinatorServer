...
pub struct Token {
    pub ident: String,     // Identifier (Username for example, could be user ID)
...
mod tests {
    ...
    fn test_token_display_ok() -> Result<()> {
        // Fixtures
        let fx_token_str = "ZngtaWRlbnQtMDE.MjAyMy0wOS0xN1QxNTozMDowMFo.some-sign-b64u-encoded";

        let fx_token = Token {
            ident: "fx-ident-01".to_string(),
            exp: "2023-09-17T15:30:00Z".to_string(),
